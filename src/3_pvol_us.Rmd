...
This chapter describes polar volume (`pvol`) data from weather radars in the United States: one the main data sources for GloBAM.

## Data collecting

US `pvol` data are collected by the National Oceanic and Atmospheric Administration ([NOAA](https://www.noaa.gov)), which operates a network of approximately 160 Next Generation Weather Radar (NEXRAD), WSR-88D sites in the US and associated territories.

## Access {#pvol-us-access} 
...
US `pvol` data are stored on AWS and other cloud services, see \@ref(pvol-us-access).
