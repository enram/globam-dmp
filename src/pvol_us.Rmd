...
1) Amazon S3, see [NEXRAD on AWS](https://registry.opendata.aws/noaa-nexrad/). Archived data are hosted in the [noaa-nexrad-level2](https://noaa-nexrad-level2.s3.amazonaws.com) Amazon S3 bucket in the us-east-1 AWS region. These data have 15-30 minutes lag relative to real-time. There is also a real-time data stream, however here scans have not been merged yet into polar volumes.
